...
const baseURL = process.env.NEXT_PUBLIC_API_BASE_URL;
  ...
  return (
    <section>
      {/* White background from top to input */}
        ...
        <div className="container mx-auto px-4 pt-12 pb-8 max-w-4xl">
          ...
          <div className="relative" ref={searchRef}>
            <Input
              ...
              className="w-full pl-12 pr-24 py-4 text-lg bg-white border-2 border-border focus:border-primary rounded-2xl shadow-lg"
            />
            <Icon
              name="Search"
              size={20}
      ...
      {/* Gray background for Top Searched Vendors */}
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {trendingSearches.slice(0, 10).map((trend, index) => (
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-white hover:bg-muted border border-border rounded-full text-sm transition-colors group"
                >
                  <img
                    src="Frame 2147223.png" // use actual image URL if available
                    alt={trend.term}
