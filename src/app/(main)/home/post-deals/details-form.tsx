  ...
  const updateField = (field: string, value: any) => {
    setFormData((prev: any) => {
      ...
      if (field === "url") {
        ...
        updated.platform = detectedPlatform;
      }
    ...
    setErrors((prev) => {
      ...
      switch (field) {
        ...
        case "discountedPrice":
          ...
          case "title":
      const titleLen = valueStr?.length ?? 0;

      if (!valueStr) {
        next.title = "Deal title is required.";
      } else if (titleLen < 10) {
      ...
      break;
        ...
        case "category":
          ...
          case "description":
      const len = valueStr?.length ?? 0;

      // If empty -> error
      if (!valueStr) {
        next.description = "Deal description is required.";
      }
      // If text exists but not enough characters -> error
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-8 space-y-8">
      ...
      <div className="space-y-6">
        ...
        className={inputStyling + " border border-transparent bg-gray-50"}
