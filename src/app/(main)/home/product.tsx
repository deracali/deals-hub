...
const baseURL = process.env.NEXT_PUBLIC_API_BASE_URL;
  ...
  return (
    <div className="container mx-auto px-4 pt-4 font-sans text-slate-900 pb-20">
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="lg:hidden flex items-center gap-2 border px-4 py-2 rounded-lg text-sm font-semibold"
          >
