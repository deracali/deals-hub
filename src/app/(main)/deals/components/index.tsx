...
const DealsDashboard = () => {
  ...
  useEffect(() => {
    const fetchCoupons = async () => {
      try {
        const res = await fetch("http://localhost:5000/api/coupons/get");
        const data = await res.json();
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="mb-10 flex items-end justify-between">
                ...
                <div className="text-left">
                  <h2 className="text-3xl font-extrabold text-foreground mb-2 leading-none">
                    Curated Collections
                  </h2>
                  <p className="text-muted-foreground max-w-lg">
                    Specially handpicked deals organized by themes and occasions
                    to save you time
                  </p>
                </div>
